$(function() {
    ...
    //# DataTable init
    window.dataTable = $("#order_list").dataTable({
        pageLength: 10,
        ...
        serverSide: true,
        ajax: {
            url : '/admin/member/company/order/list',
            data : function ( d ) {
    ...
    $('#order_list tbody').on('click', 'tr', function () { //행 클릭시
        var dt = window.dataTable;
        var data = dt.row( this ).data();
        //# 상세 페이지 이동
        location.href = '/admin/order/detail/'+data.id;
    });
