                    ...
                    <div class="box-header">
                            ...
                            {{--<div class="row" style="margin-top:10px;">
                                ...
                                <div class="col-xs-2">
                                    <select name="searchType" class="form-control select2" style="width: 100%;">
                                        @foreach(array('' => '전체', 'title' => '강의명') as $key => $value)
                        ...
                        <div class="row">
                            <div class="col-sm-6" style="margin-top:3%;">
                                <p style="margin-left:2%;">클래스이음의 강의관리 화면입니다.</p>
                            </div>
                            <div class="col-sm-6">
...
@section('plugins')
    ...
    <script type="text/javascript" src="/admin/page/class/page.class.datatable.js"></script>
