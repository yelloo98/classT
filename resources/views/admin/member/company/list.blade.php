            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <form id="form" action="/admin/member/company">
                            <div class="row">
                                ...
                                <div class="col-xs-2">
                                    <select name="searchType" class="form-control select2" style="width: 100%;">
                                        @foreach(array('email' => '이메일', 'name' => '이름', 'phone' => '연락처', 'company_name' => '회사명') as $key => $value)
                        ...
                        <div class="row">
                            <div class="col-sm-6" style="margin-top:3%;">
                                <p style="margin-left:2%;">클래스이음의 기업회원들의 정보를 열람할 수 있습니다.</p>
                            </div>
                            <div class="col-sm-6">
...
@section("script")
    ...
    <script type="text/javascript" src="/admin/page/member/company/page.companyMember.datatable.js"></script>
    <script>
