                ...
                <div class="box">
                    <div class="box-header">
                        <form id="form" action="/admin/request/teacher">
                            ...
                            <div class="row" style="margin-top:10px;">
                                <div class="col-xs-1"><span>세금계산서발행</span></div>
                                <div class="col-xs-6">
                                    <label><input type="radio" class="minimal" name="searchStatus">전체</label>
                            ...
                            <div class="row" style="margin-top:10px;">
                                ...
                                <div class="col-xs-6">
                                    <label><input type="radio" class="minimal" name="searchTax" value="all">전체</label>
                                    <label><input type="radio" class="minimal" name="searchTax" value="">발행요청</label>
                                    <label><input type="radio" class="minimal" name="searchTax" value="">발행완료</label>
                                </div>
                            </div>
                            <div class="row" style="margin-top:10px;">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="table_list" class="table table-bordered table-hover" style="vertical-align: middle!important; text-align: center">
                            <colgroup>
                                <col width="5%"/>
                                <col width="10%"/>
                                <col width="10%"/>
...
@section("script")
    ...
    {{--<script src="/admin/page/calculate/company/page.calculateCompany.datatable.js"></script>--}}
