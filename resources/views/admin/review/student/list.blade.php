            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <form id="form" action="/admin/review/student">
                            <div class="row">
                    ...
                    <div class="box-body">
                        <div class="col-xs-12">
                            <button type="button" class="btn pull-right" onclick="location.href='/admin/question'" style="margin-bottom: 1%;">평가항목관리</button>
                        </div>
...
@section("script")
    ...
    <script type="text/javascript" src="/admin/page/review/student/page.evaluateUser.datatable.js"></script>
@stop
